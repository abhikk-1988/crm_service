...
//				foreach($numbers as $number){
        ...
        if(isset($_post_data['enquiry_id']) && $_post_data['enquiry_id'] != ''){
            ...
            if($result && mysql_num_rows($result) > 0){
                ...
                $get_email_template_callback = 'SELECT * FROM email_templates WHERE email_category = "internal" AND event = "follow_up" LIMIT 1';
                ...
                if($template_resource && mysql_num_rows($template_resource) > 0){
                    ...
                    $mail_data = array(
                        ...
                        CC	=> '',
                        BCC => '',
                        SUBJECT => $callback_email_template_object -> subject,
                        TO_NAME => $agent_name
                    );
                    ...
                    $message_template_callback_int = 'SELECT * FROM message_templates WHERE message_category = "internal" AND event = "follow_up" LIMIT 1';
